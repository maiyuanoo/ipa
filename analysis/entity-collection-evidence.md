...
实体绘制原始样本 `C:\Users\马思远\Desktop\ipa\辞月0818.dylib` 与
`analysis/input/Ciyue0818.dylib` 的 SHA-256 均为
`e7b0e578c249f161a97e007d87b780a077601c4c6b3fef47da717d35935b6a16`，
两者逐字节一致。后续涉及该样本的反编译结论均可追溯到用户提供的 `ipa` 目录文件。
